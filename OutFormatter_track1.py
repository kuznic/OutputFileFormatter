...
class Openseseme:
    ...
    def Open3(self):
        try:
            ...
            filename= 'output_ghipps_track1' + timestr +'.txt'#new outputfilename
            ...
            while i < total_number_of_records-1:
                ...
                new_text = [myparameters.par1 + new_text[0] + myparameters.par2 + new_text[3] + myparameters.par2 + 
                            new_text[2] +new_text[20][21:24] + myparameters.pvki + new_text[15] + myparameters.zero +
                           myparameters.zero +new_text[12] +myparameters.zero+myparameters.zero+myparameters.zero+
                           myparameters.zero + myparameters.zero + myparameters.zero]
                ary.append(new_text)
                i=i + 1
